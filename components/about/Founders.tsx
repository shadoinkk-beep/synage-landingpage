          ...
          <div className="relative -mt-12 sm:-mt-42 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-10 gap-12 items-center sm:pl-24">
              ...
              <div className="md:col-span-8">
                <div className="relative w-full h-125  rounded-2xl">
                  <Image
                    src={FoundersPage}
                    alt="Synage Founders"
                    fill
        ...
        <div className="grid gap-12">
          ...
          <div className="relative">
            ...
            <div className="relative h-[250vh]">
              ...
              {/* ================= FOUNDER 1 ================= */}
              <div className="sticky top-12 sm:top-0 h-screen flex items-center z-15">
              ...
              {/* ================= FOUNDER 2 ================= */}
              <div className="sticky top-12 sm:top-0 h-screen flex items-center z-20">
                <div className="grid grid-cols-1 md:grid-cols-12 rounded-2xl overflow-hidden bg-[#02131B] text-[#FBF7F0] w-full max-w-7xl mx-auto shadow-2xl">

                  {/* CONTENT */}
                  <div className="hidden md:col-span-6 p-6 sm:p-12 sm:flex flex-col justify-center space-y-4">
                    <h3 className="font-body font-bold text-2xl sm:text-6xl">
                      Ujjwal Sethi
                    </h3>
                  ...
                  {/* IMAGE */}
                  <div className="md:col-span-6 relative  h-64 sm:h-[80vh]">
                    <Image
                      src={Ujjwal_Sethi}
                      alt="Ujjwal Sethi"
                      fill
                  ...
                  {/* CONTENT */}
                  <div className="sm:hidden md:col-span-6 p-6 sm:p-12 flex flex-col justify-center space-y-4">
                    <h3 className="font-body font-bold text-2xl sm:text-6xl">
                      Ujjwal Sethi
                    </h3>
