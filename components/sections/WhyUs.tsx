  ...
  const stepVariant = {
    ...
    visible: (i: number) => {
      ...
      return {
        ...
        scale: 1,
        transition: {
          delay: isCard ? (i - 4) * 0.15 : i * 0.25,
          duration: isCard ? 0.6 : 0.8,
          ease: [0.22, 1, 0.36, 1],
        },
      };
    },
  ...
  return (
    <section id="why-us" className="section section-light">
      <div className="section-content">
        ...
        {/* ================= HEADER ================= */}
        <motion.div
          className="mx-auto text-center space-y-6 max-w-5xl py-8"
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            ...
            <p className="font-body text-sm">
              Over ₹1,000+ Cr in cumulative transaction value executed for
              clients. This reflects high-ticket closures where negotiation
              discipline matters as much as the asset itself.
            </p>
          </motion.div>
        </div>
